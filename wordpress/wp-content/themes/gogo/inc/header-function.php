...
$gogo_mobile_menu_open = get_theme_mod( 'gogo_mobile_menu_open','left');
...
<div class='content-html'>
    <?php echo esc_html(get_theme_mod('gogo_col1_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
...
<?php if($content=='text'){?>
<div class='content-html'>
    <?php echo esc_html(get_theme_mod('gogo_col2_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
    if ( has_nav_menu('gogo-above-menu' ) ){?>
<!-- Menu Toggle btn-->
...
<?php if($content=='text'){?>
<div class='content-html'>
    <?php echo esc_html(get_theme_mod('gogo_col3_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
    if ( has_nav_menu('gogo-above-menu' ) ) {?>
<!-- Menu Toggle btn-->
...
<?php if($content=='text'){?>
<div class='content-html'>
    <?php echo esc_html(get_theme_mod('gogo_col1_bottom_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
...
<?php if($content=='text'){?>
<div class='content-html'>
    <?php echo esc_html(get_theme_mod('gogo_col2_bottom_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
    if ( has_nav_menu('gogo-bottom-menu' ) ) {?>
<!-- Menu Toggle btn-->
...
<?php if($content=='text'){?>
<div class='content-html'>
    <?php echo esc_html(get_theme_mod('gogo_col3_bottom_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
    if ( has_nav_menu('gogo-bottom-menu' ) ) {?>
<!-- Menu Toggle btn-->
