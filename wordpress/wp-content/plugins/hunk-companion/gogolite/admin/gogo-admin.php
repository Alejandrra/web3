...
<video autoplay="autoplay" loop="loop" id="bgvid" <?php echo $muted;?>  poster="<?php echo esc_url(get_theme_mod( 'gogo_video_image_upload')); ?>" controls>
<source src="<?php echo esc_url($video); ?>" type="video/mp4" />

<?php } 
if(hunk_companion_mobile_user_agent_switch()==true){?>
	<video autoplay="autoplay" loop="loop" <?php echo esc_attr($muted);?> poster="<?php echo esc_url(get_theme_mod( 'gogo_video_image_upload')); ?>">
   </video>	
	<?php }
   }
...
//Section Ordering
    ...
    <ul class="vertical-pagi-list">
      <?php
            ...
            $fifth   = get_theme_mod('gogo_pricing_id','pricing');

            $seventh = get_theme_mod('gogo_social_id','social');
            ...
            $fourteenth = get_theme_mod('gogo_video_ribbon_id','video');

            $fifthteenth = get_theme_mod('gogo_portfolio_id','portfolio');
    ...
    "section_pricing" => $fifth,
    "section_clients-and-testimonials" => $eight,
    "section_video-ribbon" => $fourteenth,
    "section_blog"    => $third,
    "section_thunk-social-section" =>$seventh ,
    "section_contact-us" => $eleventh,
    "section_portfolio-thunk-masonry" => $fifthteenth 
);
 ...
 if (get_theme_mod( 'gogo_pricing_hide') == '') { 
 	$section_number_show++;
 	global $pricing;
 	$pricing = $section_number_show;  ?>
 		<li>
          <a href="#<?php echo esc_attr($filter_section[$value]);?>" data-number="<?php echo esc_attr($i); ?>" class="vn-pricing">
              <span class="cd-dot"></span>
              <span class="cd-label">
              	<?php echo esc_html($filter_section[$value]); ?>
              	</span>
 	...
 	case 'section_thunk-social-section':
 if (get_theme_mod( 'gogo_social_hide') == '') { 
 	      ?>
 		<li>
          <a href="#<?php echo esc_attr($filter_section[$value]);?>" data-number="<?php echo esc_attr($i); ?>" class="vn-social-section">
              <span class="cd-dot"></span>
              <span class="cd-label">
              	<?php echo esc_html($filter_section[$value]); ?>
              	</span>
 ...
 if (get_theme_mod( 'gogo_team_hide') == '') { 
 	...
 	case 'section_video-ribbon':
 if (get_theme_mod( 'gogo_video_ribbon_hide') == '') { 
 	   ?>
 		<li>
          <a href="#<?php echo esc_attr($filter_section[$value]);?>" data-number="<?php echo esc_attr($i); ?>" class="vn-video-ribbon">
              <span class="cd-dot"></span>
              <span class="cd-label">
              	<?php echo esc_html($filter_section[$value]); ?>
              	</span>
 	...
 	case 'section_portfolio-thunk-masonry':
 if (get_theme_mod( 'gogo_portfolio_hide','1') == '') { 
 	$section_number_show++;
 	global $portfolio;
 	$portfolio = $section_number_show;   ?>
 		<li>
          <a href="#<?php echo esc_attr($filter_section[$value]);?>" data-number="<?php echo esc_attr($i); ?>" class="vn-portfolio">
              <span class="cd-dot"></span>
              <span class="cd-label">
              	<?php echo esc_html($filter_section[$value]); ?>
              	</span>
