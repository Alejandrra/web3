...
$wp_customize->add_setting( 'gogo_align_center', array(
    'default'           => false,
    'sanitize_callback' => 'gogo_sanitize_checkbox',
  ) );
  $wp_customize->add_control( new Gogo_Designer_Toggle_Control( $wp_customize, 'gogo_align_center', array(
    'label'       => esc_html__( 'Centered Layout', 'hunk-companion' ),
    'section'     => 'gogo_homepagelayout_section',
    'type'        => 'toggle',
    'settings'    => 'gogo_align_center',
  ) ) );
...
$wp_customize->add_section('gogo_pricing_section', array(
        'title'    => __('Pricing Section', 'gogo'),
        'priority' => 8,
        'panel'  => 'gogo_frontpage_section',
));

$wp_customize->add_setting( 'gogo_pricing_hide',
                array(
                    'default'  => '',
                    'priority'   => 1,
                    'sanitize_callback' => 'gogo_sanitize_checkbox',
...
$wp_customize->add_control( 'gogo_pricing_hide',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Disable section', 'hunk-companion'),
                    'section'     => 'gogo_pricing_section',
                )
);

$wp_customize->add_setting('gogo_pricing_id', 
      array(
        'default' => 'Pricing',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
));
    $wp_customize->add_control( 'gogo_pricing_id', 
    array(
        'label'    => __('Section Id', 'hunk-companion'),
        'section'  => 'gogo_pricing_section',
         'type'       => 'text',
    ...
    $wp_customize->add_setting('gogo_pricing_name', 
      array(
        'default' => 'Pricing and Plans',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
        'transport'         => 'postMessage',
));
    $wp_customize->add_control( 'gogo_pricing_name', 
    array(
        'label'    => __('Small Heading', 'hunk-companion'),
        'section'  => 'gogo_pricing_section',
         'type'       => 'text',
    ...
    $wp_customize->add_setting('gogo_pricing_heading', array(
        'default' => 'Let us make a bond with your needs',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
        'transport'         => 'postMessage',
));
    $wp_customize->add_control( 'gogo_pricing_heading', array(
        'label'    => __('Big Heading', 'hunk-companion'),
        'section'  => 'gogo_pricing_section',
         'type'       => 'text',
));

    $wp_customize->add_setting('gogo_pricing_t_c', array(
        'default' => '15 DAYS MONEY BACK GUARANTEE. NO QUESTIONS ASKED.',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
        'transport'         => 'postMessage',
));
    $wp_customize->add_control( 'gogo_pricing_t_c', array(
        'label'    => __('Terms & Condition', 'hunk-companion'),
        'section'  => 'gogo_pricing_section',
         'type'       => 'text',
));

    //Display In a slide Way
$wp_customize->add_setting( 'gogo_pricing_slider', array(
               'default'               => false,
               'sanitize_callback'     => 'gogo_sanitize_checkbox',
) );
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'gogo_pricing_slider', array(
               'label'                 => esc_html__('Display in a Slide Way', 'hunk-companion'),
               'type'                  => 'checkbox',
               'section'               => 'gogo_pricing_section',
) ) );
    //Pricing Content Via Repeater
      if ( class_exists( 'Gogo_Repeater' ) ) {
            ...
            $wp_customize->add_control(
                new Gogo_Repeater(
                    $wp_customize, 'gogo_pricing_content', array(
                        'label'                                => esc_html__( 'Pricing Content', 'hunk-companion' ),
                        'section'                              => 'gogo_pricing_section',
                        'priority'                             => 15,
                        'add_field_label'                      => esc_html__( 'Add new Pricing', 'hunk-companion' ),
                        'item_name'                            => esc_html__( 'Pricing', 'hunk-companion' ),
                    ...
                    ),'Gogo_Pricing_Repeater'
                )
            );
        }

    $wp_customize->add_setting('gogo_pricing_popular', 
      array(
        'default' => '3',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'absint',
));
    $wp_customize->add_control( 'gogo_pricing_popular', 
    array(
        'label'    => __('Highlight Popular Pricing Table No.', 'gogo'),
        'section'  => 'gogo_pricing_section',
         'type'     => 'number',
));
...
/****************/
if ( class_exists( 'Gogo_Misc_Control' ) ){
$wp_customize->add_setting('gogo_pricing_doc', array(
    'sanitize_callback' => 'gogo_sanitize_text',
    ));
$wp_customize->add_control(new Gogo_Misc_Control( $wp_customize, 'gogo_pricing_doc',
            array(
        'section'     => 'gogo_pricing_section',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'hunk-companion' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://themehunk.com/docs/gogo-theme/#pricing-section')),
        'priority'   =>30,
    ))); 
}
// Registers Pricing_background settings 
//*****************************************************
...
//*****************************************************
///////////// Video Ribbon SECTION STARTS//////////////
$wp_customize->add_section('gogo_video_ribbon_section', array(
        'title'    => __('Video Ribbon Section', 'gogo'),
        'priority' => 10,
        'panel'  => 'gogo_frontpage_section',
));

$wp_customize->add_setting( 'gogo_video_ribbon_hide',
                array(
                    'default'  => '',
                    'priority'   => 1,
                    'sanitize_callback' => 'gogo_sanitize_checkbox',
                ));
$wp_customize->add_control( 'gogo_video_ribbon_hide',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Disable section', 'hunk-companion'),
                    'section'     => 'gogo_video_ribbon_section',
                ));

$wp_customize->add_setting('gogo_video_ribbon_id', 
      array(
        'default' => 'Video-Ribbon',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
));
    $wp_customize->add_control( 'gogo_video_ribbon_id', 
    array(
        'label'    => __('Section Id', 'hunk-companion'),
        'section'  => 'gogo_video_ribbon_section',
         'type'       => 'text',
...
$wp_customize->add_setting('gogo_video_ribbon_heading', 
      array(
        'default' => 'Unique, Best, Adaptable.',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
        'transport'         => 'postMessage',
));
    $wp_customize->add_control( 'gogo_video_ribbon_heading', 
    array(
    ...
    $wp_customize->add_setting('gogo_video_ribbon_subheading', array(
        'default' => 'We provide services to assure your needs 100%.',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
        'transport'         => 'postMessage',
));
    $wp_customize->add_control( 'gogo_video_ribbon_subheading', array(
        'label'    => __('Subheading', 'hunk-companion'),
        'section'  => 'gogo_video_ribbon_section',
         'type'       => 'text',
));

$wp_customize->add_setting('gogo_video_ribbon_url', array(
        'default' => 'https://www.youtube.com/embed/Un4ItkiZ6Tw',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_textarea',
));
    $wp_customize->add_control( 'gogo_video_ribbon_url', array(
        'label'    => __('Enter the video URL', 'hunk-companion'),
        'description'=>__('NOTE: Enter the Iframe embed url', 'hunk-companion'),
        'section'  => 'gogo_video_ribbon_section',
         'type'       => 'textarea',
));

 // Registers Contact_background settings  
    $wp_customize->add_setting( 'video_ribbon_background_image_url', array(
        'default' =>  HUNK_COMPANION_VIDEO_RIBBON_BG,
        'sanitize_callback' => 'esc_url',
    ) );

    $wp_customize->add_setting( 'video_ribbon_background_image_id', array(
        'sanitize_callback' => 'absint',
    ) );

    $wp_customize->add_setting( 'video_ribbon_background_repeat', array(
        'default' => 'no-repeat',
        'sanitize_callback' => 'sanitize_text_field',
    ) );

    $wp_customize->add_setting( 'video_ribbon_background_size', array(
        'default' => 'cover',
        'sanitize_callback' => 'sanitize_text_field',
    ) );

    $wp_customize->add_setting( 'video_ribbon_background_position', array(
        'default' => 'center center',
        'sanitize_callback' => 'sanitize_text_field',
    ) );

    $wp_customize->add_setting( 'video_ribbon_background_attach', array(
        'default' => 'scroll',
        'sanitize_callback' => 'sanitize_text_field',
    ) );
    ...
    $wp_customize->add_control(
        new Hunk_Companion_Customize_Custom_Background_Control(
            $wp_customize,
            'video_ribbon_background_image',
            array(
                'label'     => esc_html__( 'Background Image', 'hunk-companion' ),
                'section'   => 'gogo_video_ribbon_section',
                'priority'   => 30,
                'settings'    => array(
                    'image_url' => 'video_ribbon_background_image_url',
                    'image_id' => 'video_ribbon_background_image_id',
                    'repeat' => 'video_ribbon_background_repeat', // Use false to hide the field
                    'size' => 'video_ribbon_background_size',
                    'position' => 'video_ribbon_background_position',
                    'attach' => 'video_ribbon_background_attach',
                )
            )
...
/****************/
if ( class_exists( 'Gogo_Misc_Control' ) ){
$wp_customize->add_setting('gogo_video_ribbon_doc', array(
    'sanitize_callback' => 'gogo_sanitize_text',
    ));
$wp_customize->add_control(new Gogo_Misc_Control( $wp_customize, 'gogo_video_ribbon_doc',
            array(
        'section'     => 'gogo_video_ribbon_section',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'hunk-companion' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://themehunk.com/docs/gogo-theme/#ribbon-section')),
        'priority'   =>30,
    )));  
}
//***************************************************
///////////// PORTFOLIO SECTION STARTS/////////////////
$wp_customize->add_section('gogo_portfolio_section', array(
        'title'    => __('Portfolio Section', 'hunk-companion'),
        'priority' => 6,
        'panel'  => 'gogo_frontpage_section',
));

$wp_customize->add_setting( 'gogo_portfolio_hide',
                array(
                    'default'  => '1',
                    'priority'   => 1,
                     'sanitize_callback' => 'gogo_sanitize_checkbox',
                ));
$wp_customize->add_control( 'gogo_portfolio_hide',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Disable section', 'hunk-companion'),
                    'section'     => 'gogo_portfolio_section',
                ));

    $wp_customize->add_setting('gogo_portfolio_id', 
      array(
        'default' => 'portfolio',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
    ));
      $wp_customize->add_control( 'gogo_portfolio_id', 
    array(
        'label'    => __('Section Id', 'hunk-companion'),
        'section'  => 'gogo_portfolio_section',
         'type'       => 'text',
));
    $wp_customize->add_setting('gogo_portfolio_name', 
      array(
    ...
    $wp_customize->add_control( 'gogo_portfolio_name', 
    array(
        'label'    => __('Small Heading', 'hunk-companion'),
        'section'  => 'gogo_portfolio_section',
         'type'       => 'text',
    ...
    $wp_customize->add_setting('gogo_portfolio_heading', array(
        'default' => 'Explore some time with our portfolio',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
        'transport'         => 'postMessage',
));
    $wp_customize->add_control( 'gogo_portfolio_heading', array(
        'label'    => __('Big Heading', 'hunk-companion'),
        'section'  => 'gogo_portfolio_section',
         'type'       => 'text',
));
...
$wp_customize->add_setting('our_port_default_images', array(
   ...
   $wp_customize->add_control('our_port_default_images', array(
        'label'    => __('Number of Portfolio Images Show', 'hunk-companion'),
        'section'  => 'gogo_portfolio_section',
   ...
   $wp_customize->add_setting('our_port_category', array(
    ...
    $wp_customize->add_control(new Gogo_Customize_Control_Checkbox_Multiple(
            $wp_customize,'our_port_category', array(
        'settings'=> 'our_port_category',
        'label'   => __( 'Show Portfolio Category ', 'hunk-companion' ),
        'description'=> __( 'Choose atleast One Category ', 'hunk-companion' ),
        'section' => 'gogo_portfolio_section',
        'choices' => $portcats,
        ) 
    ));
...
/****************/
if ( class_exists( 'Gogo_Misc_Control' ) ){
$wp_customize->add_setting('gogo_portfolio_doc', array(
    'sanitize_callback' => 'gogo_sanitize_text',
    ));
$wp_customize->add_control(new Gogo_Misc_Control( $wp_customize, 'gogo_portfolio_doc',
            array(
        'section'     => 'gogo_portfolio_section',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'hunk-companion' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://themehunk.com/docs/gogo-theme/#portfolio-section')),
        'priority'   =>30,
    )));   
}
...
$wp_customize->add_section('gogo_social_section', array(
        'title'    => __('Social Section', 'hunk-companion'),
        'priority' => 13,
        'panel'  => 'gogo_frontpage_section',
));  

$wp_customize->add_setting( 'gogo_social_hide',
                array(
                    'default'  => '',
                    'priority'   => 1,
                    'sanitize_callback' => 'gogo_sanitize_checkbox',
                ));
$wp_customize->add_control( 'gogo_social_hide',
                array(
                    'type'        => 'checkbox',
                    'label'       => esc_html__('Disable section', 'hunk-companion'),
                    'section'     => 'gogo_social_section',
                ));

    $wp_customize->add_setting('gogo_social_id', 
      array(
        'default' => 'social',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'gogo_sanitize_text',
    ));
    $wp_customize->add_control( 'gogo_social_id', 
    array(
        'label'    => __('Section Id', 'hunk-companion'),
        'section'  => 'gogo_social_section',
         'type'       => 'text',
));
          //SOCIAL Content Via Repeater
      if ( class_exists( 'Gogo_Repeater' ) ) {
            $wp_customize->add_setting(
                'gogo_social_content', array(
                    'sanitize_callback' => 'gogo_repeater_sanitize',  
            ...
            $wp_customize->add_control(
                new Gogo_Repeater(
                    $wp_customize, 'gogo_social_content', array(
                        'label'                                => esc_html__( 'Social Content', 'hunk-companion' ),
                        'section'                              => 'gogo_social_section',
                        'priority'                             => 15,
                        'add_field_label'                      => esc_html__( 'Add new Icon', 'hunk-companion' ),
                        'item_name'                            => esc_html__( 'Social Icon', 'hunk-companion' ),
                        'customizer_repeater_icon_control'  => true,
                           
                        'customizer_repeater_link_control'    => true,                   
                        'customizer_repeater_color_control' => true,
                    ),'Gogo_Social_Repeater'
                )
            );
        }
/****************/
...
/****************/
if ( class_exists( 'Gogo_Misc_Control' ) ){
$wp_customize->add_setting('gogo_social_doc', array(
    'sanitize_callback' => 'gogo_sanitize_text',
    ));
$wp_customize->add_control(new Gogo_Misc_Control( $wp_customize, 'gogo_social_doc',
            array(
        'section'     => 'gogo_social_section',
        'type'        => 'custom_message',
        'description' => sprintf( wp_kses(__( 'To know more Go with this <a target="_blank" href="%s">Doc</a> !', 'hunk-companion' ), array(  'a' => array( 'href' => array(),'target' => array() ) ) ), esc_url('https://themehunk.com/docs/gogo-theme/#social-section')),
        'priority'   =>30,
    ))); }
