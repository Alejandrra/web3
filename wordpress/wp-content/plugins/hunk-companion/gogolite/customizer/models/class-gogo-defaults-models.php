...
/**
	...
	public function get_pricing_default() {
		return apply_filters(
			'gogo_pricing_default_content', json_encode(
				array( 
					array(
						'title'     => esc_html__( 'Single', 'hunk-companion' ),
						'price'     => esc_html__( '51', 'hunk-companion' ),
						
						'subtitle'  => esc_html__( 'For 1 Site', 'hunk-companion' ),
						'text'      => esc_html__( '1 Year of Updates & Support All Features Included', 'hunk-companion' ),
						'link'       => '#',
						'text2'		 => 'BUY NOW',

					),
					array(
						'title'     => esc_html__( 'Multiple', 'hunk-companion' ),
						'price'     => esc_html__( '79', 'hunk-companion' ),
						'subtitle'  => esc_html__( 'For 5 Sites', 'hunk-companion' ),
						'text'      => esc_html__( '1 Year of Updates & Support All Pro Features Included', 'hunk-companion' ),
						'link'       => '#',
						'text2'		 => 'BUY NOW',

					),
					array(
						'title'     => esc_html__( 'Professional', 'hunk-companion' ),
						'price'     => esc_html__( '108', 'hunk-companion' ),
						'subtitle'  => esc_html__( 'For 10 Sites', 'hunk-companion' ),
						'text'      => esc_html__( '1 Year of Updates & Support All Pro Features Included', 'hunk-companion' ),
						'link'       => '#',
						'text2'		 => 'BUY NOW',
					),
...
/**
	 * Get default values for Social section.

	 * @access public
	 */
	public function get_social_section_default() {
		return apply_filters(
			'gogo_social_section_default_content', json_encode(
				array( 
					array(
