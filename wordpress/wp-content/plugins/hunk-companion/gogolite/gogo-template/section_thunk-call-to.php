...
<section id="<?php echo esc_attr(get_theme_mod('gogo_call_to_id','callto'));?>" class="thunk-call-to cd-section">
	<div class="container">
		...
		<div class="call-to-heading-wrap">
			<h2 class="call-to-heading wow fadeInLeft" data-wow-duration="2.5s">
	...
	?>
		...
		<div class="call-to-button wow fadeInRight" data-wow-duration="2.5s"><a href="<?php echo esc_url(get_theme_mod( 'gogo_call_to_button_link','')); ?>" class="type-button call-to">
