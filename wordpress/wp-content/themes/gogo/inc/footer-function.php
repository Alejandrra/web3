...
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('gogo_footer_col1_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }
elseif($content=='menu'){
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('gogo_above_footer_col2_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
...
<?php if($content=='text'){?>
<div class='content-html'>
    <?php echo esc_html(get_theme_mod('gogo_above_footer_col3_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
	if ( has_nav_menu('gogo-abv-footer-menu' ) ){?>
<?php 
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('gogo_footer_bottom_col1_texthtml',__('Copyright | Gogo | Powered by Gogo','gogo')));?>
</div>
<?php }elseif($content=='menu'){
...
<?php if($content=='text'){?>
<div class='content-html'>
   <?php echo esc_html(get_theme_mod('gogo_footer_bottom_col2_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('gogo-btm-footer-menu' ) ) {?>
<?php 
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('gogo_bottom_footer_col3_texthtml',  __( 'Add your content here', 'gogo' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('gogo-btm-footer-menu' ) ) {?>
<?php 
